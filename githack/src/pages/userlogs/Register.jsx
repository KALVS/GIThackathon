      ...
      <div className={classes['register-hero-box-wrapper']}>
        <div className={classes['register-overlay']}>
          <center>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea tempore voluptatem
              deleniti, reprehenderit ducimus quis, esse minima vitae facere culpa ad quaerat!
              Corporis tenetur aliquid soluta, odio nihil doloribus similique.
            </p>
          </center>
        </div>
      </div>
