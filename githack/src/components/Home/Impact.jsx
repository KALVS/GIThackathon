      ...
      <div className={classes["impactContainer"]}>
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 text-center mb-4">
          <div className={classes["impactWrapper"]}>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga tenetur eveniet temporibus facilis!</p>
          </div>
          <div className={classes["impactWrapper"]}>
            <IconDollar />
        ...
        <p className="text-center">You can make a difference for your community.</p>
        <span className={classes["signUpContainer"]}>
          <Button className={"text-center py-4 mb-5" && classes["signUpButton"]} variant="success">
            Sign Up
          </Button>
        </span>
      </div>
